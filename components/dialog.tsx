...
export default function Dialog({
  ...
  return createPortal(
    ...
    >
      <div
        className={
          "max-w-4xl w-dvw h-dvh sm:w-auto sm:h-auto m-0 sm:m-6 md:m-8 lg:m-12 p-4 sm:p-6 md:p-8 text-slate-800 bg-slate-100 border border-slate-200 rounded-lg shadow-xl " +
          className
        }
        onClick={(e) => {
          e.stopPropagation();
